...
'''
#roc score
roc_score_LR = LR_model.predict_proba(XV_test)[:,1]
#creating false positive score
false_positive_rate_LR, true_positive_rate_LR, threshold_LR = roc_curve(Y_test, roc_score_LR)
print('roc_auc_score for LR: ', roc_auc_score(Y_test, roc_score_LR))

show_roc_plot('LR',false_positive_rate_LR,true_positive_rate_LR)
'''
